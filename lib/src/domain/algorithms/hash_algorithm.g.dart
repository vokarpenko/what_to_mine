...
part of 'hash_algorithm.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

Serializer<HashAlgorithm> _$hashAlgorithmSerializer = new _$HashAlgorithmSerializer();
...
class _$HashAlgorithmSerializer implements StructuredSerializer<HashAlgorithm> {
  ...
  @override
  HashAlgorithm deserialize(Serializers serializers, Iterable<Object?> serialized,
      {FullType specifiedType = FullType.unspecified}) {
...
class HashAlgorithmBuilder implements Builder<HashAlgorithm, HashAlgorithmBuilder> {
  _$HashAlgorithm? _$v;
